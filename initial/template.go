...
func InitTemplate() {
	...
	beego.AddFuncMap("getDepartName", users.GetDepartsName)
	...
	beego.AddFuncMap("getOrderType", utils.GetOrderType)
	beego.AddFuncMap("getCustomername", orders.GetCustomerName)

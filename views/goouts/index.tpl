...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="header-section">
      ...
      <!--toggle button end-->
      <!--search start-->
      <form class="searchform" action="/goout/manage" method="get">
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="/goout/manage" class="hidden-xs btn btn-default">全部</a> <a href="/goout/approval" class="btn btn-warning" style="padding:4px;">待审批</a> <a href="/goout/add" class="btn btn-success">+我要外出</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
      <div class="row">
        <div class="col-sm-12">
          <section class="panel">
            <header class="panel-heading"> 外出 / 总数：{{.countGoout}}<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
                  ...
                  <td> {{if eq $v.Status 1}}
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="/goout/edit/{{$v.Id}}">编辑</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-goout-delete" data-op="delete" data-id="{{$v.Id}}">删除</a></li>
                        {{if eq $v.Status 1}}
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-goout-status" data-op="status" data-id="{{$v.Id}}">正常</a></li>
                        {{end}}
                      </ul>
                    </div>
                    {{else}} <a href="/goout/approval/{{$v.Id}}"> 查看 </a> {{end}} </td>
                </tr>
                {{else}}
                <tr>
                  <td colspan="7">你还没有申请过外出单</td>
                </tr>
                {{end}}
                </tbody>

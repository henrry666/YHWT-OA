...
func init() {
	...
	//订单
	beego.Include(&orders.OrderController{})
	beego.Include(&orders.CustomerController{})
    beego.Include(&notices.NoticesController{}) 
}
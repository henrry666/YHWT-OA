            ...
            <div class="panel-body">
              <table class="table table-hover general-table">
                ...
                <tr>
                  ...
                  <td><a href="/oagood/approval/{{$v.Id}}"> 审批 </a> </td>
                </tr>
                {{else}}
                <tr>
